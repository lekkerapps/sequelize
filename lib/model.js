...
class Model {
  ...
  _initValues(values, options) {
    ...
    // Map all raw attributes to model attributes
    for (const attr of Object.keys(values)) {
      if (this.constructor.fieldRawAttributesMap[attr] && this.constructor.fieldRawAttributesMap[attr].fieldName) {
        mappedValues[this.constructor.fieldRawAttributesMap[attr].fieldName] = values[attr];
      } else {
        mappedValues[attr] = values[attr];
      }
    }
